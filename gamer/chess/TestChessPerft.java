...
public class TestChessPerft {
  ...
  long perft(ChessState state, int depth) {
    ...
    for (ChessMove move : state.getMoves()) {
      if (state.getBoard().getPiece(move.from) == Pieces.KING &&
  ...
  ChessState INITIAL = ChessState.fromFen(
  ...
  ChessState KIWIPETE = ChessState.fromFen(
  ...
  ChessState POSITION3 = ChessState.fromFen(
  ...
  ChessState POSITION6 = ChessState.fromFen(
  ...
  // @Test
  // public void pos63() {
  //   assertEquals(3894594, perft(POSITION6, 3));
  // }
